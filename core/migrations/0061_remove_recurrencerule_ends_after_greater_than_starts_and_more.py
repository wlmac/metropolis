    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateField(
                blank=True, help_text="the date the repetition ends.", null=True
            ),
        ),
        migrations.AlterField(
            model_name="recurrencerule",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    models.Q(("repeats_every__gt", 1), ("type", "daily")),
                    models.Q(("type", "daily"), _negated=True),
                    _connector="OR",
                ),
